    ...
    private void processJSONdata(String JSONdata, Context mContext, boolean isReal) {
        ...
        try {
            ...
            for (int i = 0; i < matches.length(); i++) {
                ...
                leagueCode = match_data.getJSONObject(LINKS).getJSONObject(SOCCER_SEASON).
                        getString("href");
                leagueCode = leagueCode.replace(SEASON_LINK, "");

                //This if statement controls which leagues we're interested in the data from.
                //add leagues here in order to have them be added to the DB.
                // If you are finding no data in the app, check that this contains all the leagues.
                // If it doesn't, that can cause an empty DB, bypassing the dummy data routine.
                if (Utilies.isValidLeagueCode(leagueCode)) {
                    ...
                    match_values.put(DatabaseContract.scores_table.LEAGUE_COL, leagueCode);
