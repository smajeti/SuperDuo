...
class BarcodeGraphic extends TrackedGraphic<Barcode> {
    ...
    private BarcodeTrackerFactory.BarcodeCallback barcodeCallback;

    BarcodeGraphic(GraphicOverlay overlay, BarcodeTrackerFactory.BarcodeCallback barcodeCallback) {
        super(overlay);
    ...
    void updateItem(Barcode barcode) {
        ...
        if (barcodeCallback != null) {
            barcodeCallback.onBarCodeDetected(barcode);
        }
    }
